...
# description: >-
#   This package is responsible for verifying the version of base Python image to be 3.9
#
...
# METADATA
# title: Verify Python image version to match 3.9
# description: Confirm that the version of base base image used in the
#   Dockerfile of project is equal to 3.9
# custom:
#   short_name: verify_base_python_version
#   failure_msg: Python base image's version isn't 3.9
#   solution: Update the version of Python image in Dockerfile to 3.9
